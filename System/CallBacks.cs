...
namespace KERBALISM
{
  public sealed class Callbacks
  {
    public Callbacks()
    {
      GameEvents.onCrewOnEva.Add(ToEVA);
      GameEvents.onCrewBoardVessel.Add(FromEVA);
      GameEvents.onVesselRecoveryProcessing.Add(VesselRecoveryProcessing);
      GameEvents.onVesselRecovered.Add(VesselRecovered);
      GameEvents.onVesselTerminated.Add(VesselTerminated);
      GameEvents.onVesselWillDestroy.Add(VesselDestroyed);
      GameEvents.onVesselWasModified.Add(VesselModified);
      GameEvents.onPartCouple.Add(VesselDock);
      GameEvents.onPartDie.Add(PartDestroyed);
      GameEvents.OnTechnologyResearched.Add(TechResearched);
      GameEvents.onGUIEditorToolbarReady.Add(AddEditorCategory);
