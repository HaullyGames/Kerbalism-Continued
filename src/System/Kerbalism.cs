...
namespace KERBALISM
{
  ...
  public class Kerbalism : ScenarioModule
  {
    public override void OnLoad(ConfigNode node)
    {
      ...
      HighLogic.fetch.currentGame.Parameters.Difficulty.EnableCommNet |= (Features.KCommNet &= !Features.Signal);
    }
