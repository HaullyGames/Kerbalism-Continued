  ...
  public static class Cache
  {
    ...
    public static AntennasByFrequency GetNodeAntennaCache(CommNode node, short freq)
    {
      ...
      else
      {
        ...
        {
          node_Antennas = new AntennasByFrequency() { antennaPower = 0, relayPower = 0, antennaRate = 0, relayRate = 0, AntennasList = new List<AntennaPartInfo>() };
        }
      }
    ...
    public static List<short> GetFrequencies(CommNode a)
    {
      ...
      {
        aFreqs = AntennaInfo(FindCorrespondingVessel(a)).antennasByFreq.Keys.ToList();
      }
